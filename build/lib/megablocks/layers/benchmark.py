...
def run_megablocks(top_k, expert_num, seq_len, hid_dim):
    pass
...
if __name__ == "__main__":
    ...
    parser.add_argument("--top_k", type=int, required=True, help="Batch size")
    parser.add_argument("--E", type=int, required=True, help="Number of heads")
    parser.add_argument("--S", type=int, required=True, help="Context length")
    ...
    # Execute the test
    run_megablocks(args.top_k, args.E, args.S, args.HEAD_DIM)